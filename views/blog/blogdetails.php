...
<?php foreach($commentaires_blogdetails as $comment) : ?>
                                    ...
                                    <ul class="media-list">
                                        <li class="media">
                                            ...
                                            <a class="pull-left">
                                                    <img class="media-object" src="contents/images/blogdetails/2.png" alt="illustration" width="100px">
                                                </a>
                                                <div class="media-body">
                                                    <span><i class="fa fa-user"></i>Posté par <?= $comment['COM_AUTEUR'] ?></span>
                                                    <p><?= $comment['COM_CONTENU'] ?></p>
                                                    <ul class="nav navbar-nav post-nav">
                                                        <li><i class="fa fa-clock-o"></i>  <?= $comment['COM_DATE_FR'] ?></li>
                                                        <li><a href="javascript:modcom('<?= $comment['COM_ID'] ?>','<?= $comment['COM_AUTEUR'] ?>')"> <i class="fa fa-bell-o"></i> Signaler ce commentaire </a></li>
                                                    </ul>
                                                </div>
                                            </div>
...
<?php foreach($commentaires as $commentaire) : ?>
                            ...
                            <div class="media">
                                ...
                                <div class="media-body">
                                    <h4><a href="<?= "index.php?action=billet&id=" . $commentaire['BIL_ID'] ?>"><?= $commentaire['COM_CONTENU'] ?></a></h4>

...
<?php foreach($moderation_signal as $mod_signal) : ?>

                        <div class="col-sm-12 col-md-12">
                            <div class="single-blog single-column">
                                    <img src="contents/images/blog/<?= $mod_signal['BIL_ID'] ?>.jpg" class="img-responsive" width="30%" alt="illustration"><br />
                                    <h2 class="post-title bold-2"><a href="<?= "index.php?action=billet&id=" . $mod_signal['BIL_ID'] ?>">Commentaire de <?= $mod_signal['COM_AUTEUR'] ?> </a></h2>
                                    <h5>Posté le <?= $mod_signal['COM_DATE_FR'] ?> </h5>
                                    <h3 class="post-author"><?= $mod_signal['COM_CONTENU'] ?> </h3>
                                        <p><i class="fa fa-pencil-square-o"></i><a href="<?= "index.php?action=mod_modif&id=" . $mod_signal['COM_ID'] ?>"> Modifier ce commentaire </a></p>
                                        <p><i class="fa fa-check"></i><a href="javascript:okcom('<?= $mod_signal['COM_ID'] ?>','<?= $mod_signal['COM_AUTEUR'] ?>')"> Valider ce commentaire </a></p>
                                        <p><i class="fa fa-times"></i><a href="javascript:delcom('<?= $mod_signal['COM_ID'] ?>','<?= $mod_signal['COM_AUTEUR'] ?>')"> Effacer ce commentaire </a></p>

...
foreach($chapitres_admin as $chapitres) : ?>
                                ...
                                <form action="" method="post">
                                    ...
                                    <input type="text" name="BIL_TITRE" id="BIL_TITRE" size="125" value="<?= $chapitres['BIL_TITRE'] ?>"></p>

                                    <p><label for="chapitre_Auteur">Auteur</label><br />
                                    <input type="text" name="BIL_AUTEUR" id="BIL_AUTEUR" size="125" value="<?= $chapitres['BIL_AUTEUR'] ?>"></p>

                                    <p><label for="chapitre_Date">Date</label><br />
                                    <input type="date" name="BIL_DATE" id="BIL_DATE" size="125" value="<?= $chapitres['BIL_DATE_FR'] ?>"></p>

                                    <p><label for="chapitre_Contenu">Contenu du chapitre</label><br />
                                    <textarea name="BIL_CONTENU" id="BIL_CONTENU"><?= $chapitres['BIL_CONTENU'] ?></textarea></p><br />

                                    <input type="hidden" name="BIL_ID" id="BIL_ID" value="<?= $chapitres['BIL_ID'] ?>" />

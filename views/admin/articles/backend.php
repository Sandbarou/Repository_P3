...
<?php foreach($chapitres_blog as $chapitre) : ?>
                         ...
                         <div class="col-sm-12 col-md-12">
                            <div class="single-blog single-column">
                                    <img src="contents/images/blog/<?= $chapitre['BIL_ID'] ?>.jpg" class="img-responsive" width=30%; alt="illustration">
                                 <div class="post-content overflow">
                                    <h2 class="post-title bold-2"><a href="<?= "index.php?action=billet&id=" . $chapitre['BIL_ID'] ?>"> <?= $chapitre['BIL_TITRE'] ?> </a></h2>
                                    ...
                                    <p><a href="<?= "index.php?action=billet&id=" . $chapitre['BIL_ID'] ?>" class="read-more">Voir plus...</a></p>
                                    <p><i class="fa fa-pencil-square-o"></i><a href="<?= "index.php?action=modification&id=" . $chapitre['BIL_ID'] ?>">  Modifier ce chapitre </a></p>
                                    <p><i class="fa fa-times"></i><a href="javascript:delpost('<?= $chapitre['BIL_ID'] ?>','<?= $chapitre['BIL_TITRE'] ?>')">  Effacer ce chapitre </a></p>
